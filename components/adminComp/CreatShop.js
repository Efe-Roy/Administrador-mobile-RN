...
export default function CreatShop({setIsModalVisible}) {
  ...
  const uploadFormData = async () => {
    ...
    const url = `${baseURL}/shops-create/`;
  ...
  return (
    <ScrollView className='flex-1'>
      <View className='flex-1'>
        <Text className='text-xl mt-5 text-center font-bold'>Agregar formulario de tienda</Text>
        ...
        />
        <TextInput
          placeholder="Introduce la descripción de la tienda"
          className='w-[90%] h-12 rounded-lg border border-gray-300 pl-5 pr-5 mt-7 self-center'
          value={description}
        ...
        <TextInput
          placeholder="Introduzca su nombre de usuario personal"
          className='w-[90%] h-12 rounded-lg border border-gray-300 pl-5 pr-5 mt-7 self-center'
          value={username}
