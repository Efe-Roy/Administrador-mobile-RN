...
export default function Add({setSelectedTab}) {
    ...
    <ScrollView className='flex-1'>
      <View className='flex flex-row justify-between w-[100%] px-4 mt-5 items-center'>
        <TouchableOpacity onPress={()=>navigation.toggleDrawer()}>
          <Icon.AlignRight height={20} width={20} strokeWidth="2.5" stroke="black" />
        </TouchableOpacity>
          <Icon.MoreVertical height={20} width={20} strokeWidth="2.5" stroke="black" />
      </View>
      <View className='flex-1'>
        <Text className='text-xl mt-5 text-center font-bold'>Añadir artículo</Text>
